...
若要使用這些已儲存的 `PTTimedMetadata` 物件時，使用儲存的字典，從 [在傳送時儲存定時中繼資料物件](../../../tvsdk-3x-ios-prog/ios-3x-advertising/ios-3x-custom-tags-configure/ios-3x-timed-metadata-store.md).
