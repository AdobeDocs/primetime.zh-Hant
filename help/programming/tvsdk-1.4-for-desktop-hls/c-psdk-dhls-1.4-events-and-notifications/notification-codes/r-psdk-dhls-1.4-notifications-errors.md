...
<table frame="all" colsep="1" rowsep="1" id="table_8B61210A406A45ACBE37FC29729DDE22"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5">另請參閱106000( <span class="codeph"> NATIVE_ERROR</span>)。
   </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> 無 </td> 
   <td colname="4"><span class="codeph"> RUNTIME_CODE</span> _RUNTIME <span class="codeph"> _CODE_MESSAGE</span> RESOURCE_URL資源 <span class="codeph"> _TYPE</span><span class="codeph"></span><span class="codeph"> RESOURCE_ID</span> <p><b>DRM詳細資訊：</b> </p> <span class="codeph"> DRM_ERROR_STRING</span><span class="codeph"> RUNTIME_SUBERROR_CODE</span> </td> 
   <td colname="5"> <p>低級AVE庫發出錯誤。 </p> <p>如需 <a href="../../c-psdk-dhls-1.4-events-and-notifications/notification-codes/c-psdk-dhls-1.4-native-error-summary.md" format="html" scope="external"> 這些中繼資料索引鍵值的相關資訊</a> ，請參閱NATIVE_ERROR通知的詳細資訊。 </p> </td> 
  </tr> 
  <tr rowsep="1"> 
