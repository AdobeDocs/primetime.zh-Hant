...
<table frame="all" colsep="1" rowsep="1" id="table_C24772DF203B4DB2ACE6B475698C4C58"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> <p>低級AVE庫發出錯誤。 </p> <p>有關這些元資料欄位的值的詳細資訊，請參閱NATIVE_ERROR通知</a>的<a href="../../c-psdk-dhls-1.4-events-and-notifications/notification-codes/c-psdk-dhls-1.4-native-error-summary.md" format="html" scope="external">詳細資訊。 </a></p> </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="4"><b>DRM</b> <p><span class="codeph"> NATIVE_SUBERROR_</span> <span class="codeph"> CODEDRM_ERROR_STRING</span> </p> </td> 
   <td colname="5">DRM次要錯誤碼和DRM伺服器錯誤字串。 有關這些元資料欄位的值的詳細資訊，請參閱NATIVE_ERROR通知</a>的<a href="../../c-psdk-dhls-1.4-events-and-notifications/notification-codes/c-psdk-dhls-1.4-native-error-summary.md" format="html" scope="external">詳細資訊。
   </a></td> 
  </tr> 
  <tr rowsep="1"> 
