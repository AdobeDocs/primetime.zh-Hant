...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 媒體讀取器無法載入區段，因為它已經到達即時視窗的結尾。 伺服器向即時視窗新增媒體時，將會繼續載入區段。 達到此狀態通常發生於： 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">下一個期間是即時期間，媒體取代專案仍在等待中(由於 <span class="codeph"> 插入方式</span> API呼叫) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Flash Player中尚未啟用HLS播放。 另請參閱 <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
