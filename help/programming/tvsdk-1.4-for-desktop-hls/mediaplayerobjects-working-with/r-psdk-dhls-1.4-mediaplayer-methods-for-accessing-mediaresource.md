...
<table frame="all" colsep="1" rowsep="1" id="table_77B55D506FE24326A03D97AA087231FF"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> <p>如果串流有替代的音軌，則為true。 </p> <p>提示： 主音軌（預設）也是替代音軌清單的一部分。 </p> <p>Desktop HLS的TVSDK會將主音軌視為替代音軌清單中的項目之一。 因此，MediaPlayerItem.hasAlternateAudio只會在串流完全沒有音訊時傳回 <span class="codeph"></span> false。 如果內容只有一個音軌，此方法會傳回true，而 <span class="codeph"> AudioTracks會傳 </span> 回包含單一元素（預設音軌）的清單。 </p> </td> 
  </tr> 
  <tr rowsep="1"> 
