...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 擴充音軌以定義音軌抽象化的類別。</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 可擴充Track以定義隱藏字幕抽象化的類別。 隱藏字幕音軌由其名稱AND其服務類型唯一定義。 不同的服務類型可以共用相同的名稱。</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> 包含預設隱藏字幕的類別會追蹤類型。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 定義DRM元資料抽象的類。 </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/info/Profile.html" format="html" scope="external"> 描述檔</a></span></td> 
