...
您可以使用Primetime播放器API來自訂播放器的行為。 這些類別會說明您的媒體播放器及其資源。

若要檢視TVSDK的完整API檔案，請前往 [Adobe Primetime API參考](https://help.adobe.com/en_US/primetime/api/index.html).

這些類別會說明您的媒體播放器及其資源。
封裝： [com.adobe.mediacore](https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/package-detail.html)
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 封裝所有緩衝區控制引數的類別。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 廣告播放行為的預設實施。 允許應用程式自訂廣告行為的介面。 </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">預設實施 <span class="codeph"> MediaPlayerClient</span> 提供中繼資料和廣告解析程式支援的工廠。 </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2">預設類別實作 <span class="codeph"> MediaPlayer</span> 介面。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">的公共介面 <span class="codeph"> DefaultMediaPlayer</span> 類別。 包括Event、PlayerState和Visibility的列舉。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 為媒體播放器提供額外內容的類別。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2">檢視的類別，將由 <span class="codeph"> MediaPlayer</span> 用於視訊演算。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 包含支援的媒體資源型別的類別。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="0"> 
   ...
   <td colname="2"> 提供TVSDK版本和說明的類別。 </td> 
  </tr> 
 </tbody> 
</table>
