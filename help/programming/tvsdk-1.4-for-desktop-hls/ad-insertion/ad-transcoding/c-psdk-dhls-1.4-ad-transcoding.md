...
如需CRS的詳細資訊，請參 [閱Creative Packaging Service(CRS)](https://helpx.adobe.com/content/dam/help/en/primetime/guides/crs.pdf)。
...
>[!IMPORTANT]
>
>您的應用程式實作必須檢查 `URLTransformerInputType` 列舉，且只能轉換CRS類 `URLTransformerInputType.CRSCreative` 型的URL。
