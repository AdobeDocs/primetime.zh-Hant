...
Primetime廣告插入後端會維護一組優先順序，讓它能夠在相同的VAST/VMAP回應中，選擇不同的媒體類型。 您可在[CRS](../../../../dynamic-ad-insertion/creative-repackaging-service/crs-overview.md)概述中進一步瞭解此優先順序清單以及如何變更。
