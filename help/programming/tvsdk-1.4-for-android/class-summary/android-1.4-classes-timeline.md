...
<table frame="all" colsep="1" rowsep="1" id="table_6752E908BA6546549619994A3F7D5F87"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/timeline/PlacementOpportunity.html" format="html" scope="external"> PlacementPortunity</a></span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> 代表時間軸上標籤的介面。 這會在實際時間軸上標籤感興趣的區域。 目前，感興趣的地區是廣告，您可能會想要以不同的顏色在拖曳列UI上加以標籤。 每個標籤都由位置和持續時間（每個均以毫秒表示）定義。 </td> 
  </tr> 
  <tr rowsep="0"> 
   ...
   <td colname="2"> 影響時間軸之所有作業的基底類別。 </td> 
  </tr> 
 </tbody> 
</table>
