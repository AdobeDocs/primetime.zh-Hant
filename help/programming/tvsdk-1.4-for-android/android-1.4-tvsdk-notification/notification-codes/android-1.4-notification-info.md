---
description: 此表格提供有關「資訊」的詳細資訊。 輸入通知。
title: INFO通知代碼
...
<table frame="all" colsep="1" rowsep="1" id="table_503463046E764A87B10EB5D8B294EB23"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> 已接受建議的廣告插播 <code>primetime-sdk-name</code> 並放置（完整或部分）在播放時間軸上。 </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> 傳回使用者已點選廣告的相關資訊。 </td> 
  </tr> 
  <tr rowsep="1"> 
