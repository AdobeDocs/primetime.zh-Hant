...
1. 若要實作具有DVR支援的控制列，請依照「顯示具有目前播放位置……」( [Display a seek scrub bar with the current playback position...)中的步驟進行。](../../../tvsdk-2.7-for-android/content-playback-options/ui-configure/t-psdk-android-2.7-ui-seek-scrub-bar-display.md) 有下列差異：
