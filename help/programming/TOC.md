...
+ DesktopHLS專用的TVSDK 1.4 {#tvsdk-1-4-for-desktop-hls}
   + 簡介 {#introduction}
...
+ Browser-TVSDK-2.4 {#browser-tvsdk-2-4}
   ...
   + 使用者介面架構 {#user-interface-framework}
   ...
   + 內容播放選項 {#content-playback-options}
      ...
      + 監聽Primetime Player活動 {#listen-events}
