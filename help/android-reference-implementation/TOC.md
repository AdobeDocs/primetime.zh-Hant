...
+ Primetime參考實作 {#reference}
   ...
   + 如何使用功能管理員 {#feature-managers}
      ...
      + [使用「管理員工廠」開啟或關閉功能](ref-implementation/using-feature-managers/turning-features-on-off.md)
   ...
   + 設定您的開發環境 {#setup-dev}
      ...
      + [下載及設定先決條件軟體](set-up-dev-environment/download-prereqs-android.md)
   ...
   + 設定播放器以播放具有廣告的DVR播放 {#dvr}
      ...
      + [含廣告插入的DVR](implement-video-playback/dvr/dvr-with-ad-insertion.md)
   ...
   + Primetime驗證權益流程 {#primetime-authentications}
      ...
      + [軟體權利檔案管理員概觀](paytvpass-entitlement/entitlement-overvivew.md)
