...
* CRS: 新增封鎖特定廣告系統、廣告ID、創意ID、創意URL及／或創意格式之CRS要求的能力

   >注意
   >
   >當找到相同廣告具有動態值（例如，URL中的動態參數）的廣告提供者時，Adobe會新增區塊清單規則。 在動態元件解決後，此類塊清單規則將被禁用，無論是由提供方還是通過標準化規則。

   * 如果您要為您的區域添加阻止清單或允許清單規則，請與技術客戶經理聯繫以獲得幫助。
